#undef HFDATADRIVEN_API
#undef HFDATADRIVEN_VTABLE
...
#define UE_PROJECT_NAME RaceCar
...
#define HFDATADRIVEN_VTABLE DLLEXPORT_VTABLE
#define HFDATADRIVEN_API DLLEXPORT
